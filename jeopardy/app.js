class Jeopardy {
    ...
    sampling() {
        // create an array of 6 random indices that would correspond to the indices of the categories we need. 
        // This would return non-repetitive 6 random indices between 0 and 99
        let sampledIds = [];
        for(let i = 0; i < this.numCat; i++) {
